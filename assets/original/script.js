...
function tumblr(e) {
    ...
    for (var n = 0; n < t.length; n++) {
        var r = t[n],
            i = r["regular-title"] || r["link-text"] || null;
        i && $ul.append('<li><a href="' + r.url + '">' + i + "</a></li>")
    }
}
...
(function(e) {
    ...
    n.prototype = {
        show: function() {
            ...
            if (t && this.enabled) {
                ...
                var r = e.extend({}, this.$element.offset(), {
                    ...
                    i = n[0].offsetWidth,
                    s = n[0].offsetHeight,
                    o = typeof this.options.gravity == "function" ? this.options.gravity.call(this.$element[0]) : this.options.gravity,
                    u;
                switch (o.charAt(0)) {
                    case "n":
                        u = {
                ...
                o.length == 2 && (o.charAt(1) == "w" ? u.left = r.left + r.width / 2 - 15 : u.left = r.left + r.width / 2 - i + 15);
        ...
        getTitle: function() {
            ...
            typeof r.title == "string" ? e = n.attr(r.title == "title" ? "original-title" : r.title) : typeof r.title == "function" && (e = r.title.call(n[0]));
            e = ("" + e).replace(/(^\s*|\s*$)/, "");
            return e || r.fallback
        },
        tip: function() {
            this.$tip || (this.$tip = e('<div class="tipsy"></div>').html('<div class="tipsy-arrow"></div><div class="tipsy-inner"/></div>'));
            return this.$tip
        },
        validate: function() {
    ...
    e.fn.tipsy = function(t) {
        ...
        function i() {
            var e = r(this);
            e.hoverState = "in";
            t.delayIn == 0 ? e.show() : setTimeout(function() {
...
(function(e) {
    ...
    e.fn.fitVids = function(t) {
        ...
        return r.className = "fit-vids-style", r.innerHTML = "&shy;<style>               .fluid-width-video-wrapper {                 width: 100%;                              position: relative;                       padding: 0;                            }                                                                                   .fluid-width-video-wrapper iframe,        .fluid-width-video-wrapper object,        .fluid-width-video-wrapper embed {           position: absolute;                       top: 0;                                   left: 0;                                  width: 100%;                              height: 100%;                          }                                       </style>", i.parentNode.insertBefore(r, i), t && e.extend(n, t), this.each(function() {
            ...
            n
                .customSelector && t.push(n.customSelector);
...
$(document).ready(function() {
    ...
    /* はてなスター関連 */
    $(".entry-content pre:not(.line-pre)").addClass("prettyprint");
    setTimeout(function() {
