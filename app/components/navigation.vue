      ...
      <div class="col-sm-12 col-md-12 col-lg-10 col-xl-10">
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top p-0">
          <div class="container">
            ...
            <NuxtLink class="navbar-brand fw-bold" to="/">{{ site.title }}</NuxtLink>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
              <ul class="navbar-nav mb-2 mb-lg-0 align-items-baseline">
                <template v-for="menu in site.menu.main"> <!--{{ range .Site.Menus.main.ByWeight }}-->

                  <template v-if="hasChildren(menu)"> <!--{{ if .HasChildren }}-->
                    ...
                    <li class="nav-item">
                      ...
                      <NuxtLink class="nav-link active" :title="menu.name"
                        :to="menu.url"> {{ menu.name }}</NuxtLink>
                    </li>
              ...
              <!--{{ if hugo.IsMultilingual }}
                ...
                <li class="nav-item dropdown">
                  <button class="d-flex align-items-center gap-1 p-1 border-0 bg-white" data-bs-toggle="dropdown" aria-expanded="false">
                    {{ $.Language.Lang }}
